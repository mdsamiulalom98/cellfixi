            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <!-- nav items end -->
                        <!--<li>-->
                        <!--    <a href="#sidebar-ourgallery" data-bs-toggle="collapse">-->
                        <!--        <i data-feather="package"></i>-->
                        <!--        <span> Our Gallery </span>-->
                        <!--        <span class="menu-arrow"></span>-->
                        <!--    </a>-->
                        <!--    <div class="collapse" id="sidebar-ourgallery">-->
                        <!--        <ul class="nav-second-level">-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('ourgallery.create') }}"><i data-feather="minus"></i>-->
                        <!--                    Create</a>-->
                        <!--            </li>-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('ourgallery.index') }}"><i data-feather="minus"></i>-->
                        <!--                    Manage</a>-->
                        <!--            </li>-->
                        <!--        </ul>-->
                        <!--    </div>-->
                        ...
                        <li>
                            <a href="#siebar-Production" data-bs-toggle="collapse">
                                <i data-feather="globe"></i>
                                <span>Products</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="siebar-Production">
                                <ul class="nav-second-level">
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('category.index') }}"><i data-feather="minus"></i>
                                            Category Manage</a>
                                    </li>
                                    <li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebar-blogs">
                                <ul class="nav-second-level">
                                    <li>
                        ...
                        <!--        <ul class="nav-second-level">-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('videos.create') }}"><i data-feather="minus"></i>New</a>-->
                        <!--            </li>-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('videos.index') }}"><i data-feather="minus"></i>Manage</a>-->
                        <!--            </li>-->
                        <!--        </ul>-->
                        <!--    </div>-->
                        <!--</li>-->
                        ...
                        <!--        <ul class="nav-second-level">-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('galleries.create') }}"><i data-feather="minus"></i>-->
                        <!--                    New</a>-->
                        <!--            </li>-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('galleries.index') }}"><i data-feather="minus"></i>-->
                        <!--                    Manage</a>-->
                        <!--            </li>-->
                        <!--        </ul>-->
                        <!--    </div>-->
                        ...
                        <!-- nav items end -->
                        <!--<li>-->
                        <!--    <a href="#sidebar-profile" data-bs-toggle="collapse">-->
                        <!--        <i data-feather="book"></i>-->
                        <!--        <span>Company Profile</span>-->
                        <!--        <span class="menu-arrow"></span>-->
                        <!--    </a>-->
                        <!--    <div class="collapse" id="sidebar-profile">-->
                        <!--        <ul class="nav-second-level">-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('profile.create') }}"><i data-feather="minus"></i>-->
                        <!--                    Create</a>-->
                        <!--            </li>-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('profile.index') }}"><i data-feather="minus"></i>-->
                        <!--                    Manage</a>-->
                        <!--            </li>-->
                        <!--        </ul>-->
                        <!--    </div>-->
                        ...
                        <!-- nav items end -->
                        <!--<li>-->
                        <!--    <a href="#sidebar-teams" data-bs-toggle="collapse">-->
                        <!--        <i data-feather="book"></i>-->
                        <!--        <span>Our Team</span>-->
                        <!--        <span class="menu-arrow"></span>-->
                        <!--    </a>-->
                        <!--    <div class="collapse" id="sidebar-teams">-->
                        <!--        <ul class="nav-second-level">-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('teams.create') }}"><i data-feather="minus"></i>-->
                        <!--                    Create</a>-->
                        <!--            </li>-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('teams.index') }}"><i data-feather="minus"></i> Manage</a>-->
                        <!--            </li>-->
                        <!--        </ul>-->
                        <!--    </div>-->
                        <!--</li>-->
                        <!-- nav items end -->
                        <!--<li>-->
                        <!--    <a href="#sidebar-bussinessgallery" data-bs-toggle="collapse">-->
                        <!--        <i data-feather="book"></i>-->
                        <!--        <span>Our Technology</span>-->
                        <!--        <span class="menu-arrow"></span>-->
                        <!--    </a>-->
                        <!--    <div class="collapse" id="sidebar-bussinessgallery">-->
                        <!--        <ul class="nav-second-level">-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('bussinessgallery.create') }}"><i data-feather="minus"></i>-->
                        <!--                    Create</a>-->
                        <!--            </li>-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('bussinessgallery.index') }}"><i data-feather="minus"></i>-->
                        <!--                    Manage</a>-->
                        <!--            </li>-->
                        <!--        </ul>-->
                        <!--    </div>-->
                        ...
                        <!-- nav items end -->
                        <!--<li>-->
                        <!--    <a href="#sidebar-Sustainability" data-bs-toggle="collapse">-->
                        <!--        <i data-feather="book"></i>-->
                        <!--        <span>Sustainability</span>-->
                        <!--        <span class="menu-arrow"></span>-->
                        <!--    </a>-->
                        <!--    <div class="collapse" id="sidebar-Sustainability">-->
                        <!--        <ul class="nav-second-level">-->
                        <!--            <li>-->
                        ...
                        <!--<li>-->
                        <!--    <a href="#sidebar-clients" data-bs-toggle="collapse">-->
                        <!--        <i data-feather="book"></i>-->
                        <!--        <span>Trusted Partner</span>-->
                        <!--        <span class="menu-arrow"></span>-->
                        <!--    </a>-->
                        <!--    <div class="collapse" id="sidebar-clients">-->
                        <!--        <ul class="nav-second-level">-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('companyphotos.create') }}"><i data-feather="minus"></i>-->
                        <!--                    Create</a>-->
                        <!--            </li>-->
                        <!--            <li>-->
                        <!--                <a href="{{ route('companyphotos.index') }}"><i data-feather="minus"></i>-->
                        <!--                    Manage</a>-->
                        <!--            </li>-->
                        <!--        </ul>-->
                        <!--    </div>-->
