...
@section('title', 'Company Profile Create')
@section('css')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Company Profile Create</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.store') }}" method="POST" class=row data-parsley-validate=""
                         ...
                         <div class="col-sm-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @error('pdf') is-invalid @enderror"
                                    name="pdf" id="pdf" accept="application/pdf" required>
                                @error('pdf')
