    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('roles.update') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    @foreach ($permission as $value)
                                        <div class="col-sm-4 col-md-3 col-xl-3 my-1">
                                            <div class="form-check">
                                                <input type="checkbox" name="permission[]" class="form-check-input"
                                                    value="{{ $value->id }}" id="customCheck{{ $value->id }}"
                                                    @foreach ($edit_data->permissions as $permission) {{ $permission->id == $value->id ? 'checked' : '' }} @endforeach>
