                        ...
                        <form action="{{ route('contact.update') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="hotline" class="form-label">Phone Number 1 </label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="hotmail" class="form-label">Email Addres 1</label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group mb-3">
                                    <label for="email" class="form-label">Email Address 2 *</label>
                               ...
                               <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('google_map') is-invalid @enderror"
                                        name="google_map" value="{{ old('google_map') }}" id="google_map">{{$edit_data->google_map}}</textarea>
