    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Order Process </h4>
            </div>
        </div>
    </div>       
    <!-- end page title --> 
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>1</td>
                            <td><img src="{{asset($data->bookdetails?$data->bookdetails->image_one:'')}}" height="50" width="50" alt=""></td>
                            <td>{{ $data->bookdetails->name}}</td>
                            <td>{{$data->amount}}</td>
                        </tr>
                    ...
                    <input type="hidden" name="id" value="{{$data->id}}">
                            ...
                            <div class="col-sm-6">
                              <div class="form-group mb-3">
                                   ...
                                   <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{$data->name ??''}}" placeholder="Name">
                                     @error('name')
                             ...
                             <div class="col-sm-6">
                              <div class="form-group mb-3">
                                   ...
                                   <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" value="{{$data->phone ?? ''}}" placeholder="Phone Number">
                                     @error('phone')
                                      <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                      </span>
                             ...
                             <div class="col-sm-12">
                              <div class="form-group mb-3">
                                   ...
                                   <textarea name="address" class="form-control @error('address') is-invalid @enderror">{{$data->address ?? ''}}</textarea>
                                    @error('address')
                                      <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                      </span>
