                           ...
                           <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <select name="category" class="form-select" id="category">
                                    ...
                                    <option value="1" {{ $edit_data->category == 1 ? 'selected' : '' }}>Mission</option>
                                    <option value="2" {{ $edit_data->category == 2 ? 'selected' : '' }}>Vission</option>
                                    <option value="3" {{ $edit_data->category == 3 ? 'selected' : '' }}>Story</option>
                                </select>
                            </div>
                        </div>
