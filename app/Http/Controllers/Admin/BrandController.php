...
class BrandController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backEnd.companyphotos.index', compact('data'));
    }
    public function create()
    {
        return view('backEnd.companyphotos.create');
    }
    public function store(Request $request)
    {
        ...
        if ($image) {
            ...
            $uploadpath = 'public/uploads/companyphotos/';
        ...
        return redirect()->route('companyphotos.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backEnd.companyphotos.edit', compact('edit_data', 'brands'));
    }
