...
class HowItWorkController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backEnd.upcommingevent.index', compact('show_data'));
    }
    public function create()
    {
        return view('backEnd.upcommingevent.create');
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('upcommingevents.index');
    }

    public function edit($id)
    {
        $edit_data = HowItWork::find($id);
        return view('backEnd.upcommingevent.edit', compact('edit_data'));
    }
